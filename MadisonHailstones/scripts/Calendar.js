class Calendar
{
  ...
  generateCaption(monthText)
  {
    ...
    right.innerText = String.fromCodePoint(0x2B9E);
    ...
    left.innerText = String.fromCodePoint(0x2B9C);
  ...
  generateMonth(date)
  {
    ...
    this.generateCaption(date.toLocaleString('default', { month: 'long', year: 'numeric' }));
   ...
   *
   */
  afterTargetDate(sourceDate, targetDate)
  {
